...
with_node \
  ...
  --target "/Users/emmanuelimarhiagbe/Documents/DevGuides/ios/Pods/Target Support Files/Pods-DevGuides/ExpoModulesProvider.swift" \
  --entitlement "/Users/emmanuelimarhiagbe/Documents/DevGuides/ios/DevGuides/DevGuides.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-updates"
